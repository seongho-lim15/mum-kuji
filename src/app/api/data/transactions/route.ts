...
export async function POST(request: NextRequest) {
  try {
    ...
    const transactions = await DataService.addUserTransaction(
      email,
      newTransaction,
    );
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const transactions = await DataService.updateUserTransaction(
      email,
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const transactions = await DataService.removeUserTransaction(
      email,
      parseInt(transactionId),
    );
